...
void RunnerPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData RunnerPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RunnerPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RunnerPlugin,
      qt_meta_data_RunnerPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RunnerPlugin::getStaticMetaObject() { return staticMetaObject; }
