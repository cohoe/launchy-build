...
static const char qt_meta_stringdata_IconCache[] = {
    "IconCache\0\0url\0findIcon(QUrl)\0"
    "finished(QNetworkReply*)\0query(QUrl)\0"
};
...
void IconCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->findIcon((*reinterpret_cast< QUrl(*)>(_a[1]))); break;
        case 1: _t->finished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: _t->query((*reinterpret_cast< QUrl(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData IconCache::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IconCache::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IconCache,
      qt_meta_data_IconCache, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &IconCache::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IconCache))
...
// SIGNAL 0
void IconCache::findIcon(QUrl _t1)
{
